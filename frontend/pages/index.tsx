  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white font-body selection:bg-accent-primary/30 selection:text-white">
      <Head>
        ...
        <meta
          name="description"
          content="Predict battery health, state of charge, and end-of-life using hybrid physics + ML models."
        />
      ...
      <main className="relative z-10">
        ...
        <section className="px-8 py-20 max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-400 max-w-3xl mx-auto">
              Enter your battery parameters below to get instant predictions for
              State of Health (SoH), remaining lifespan, and actionable
              insights. Works for any battery in any industry.
            </p>
          </div>
        ...
        <section className="px-8 py-12 max-w-7xl mx-auto">
          {!results ? (
            <>
              ...
              <div className="bg-gray-800/50 backdrop-blur border border-gray-700 rounded-xl p-8 mb-12">
                ...
                <p className="text-gray-400 mb-6">
                  Enter your battery specifications. VoltTwin uses a hybrid
                  physics + ML model to predict battery health.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      Shows the battery's remaining capacity as a percentage of
                      original.
                      <br />
                      <br />
                      ...
                      Healthy
                      <br />
                      <span className="text-yellow-400">🟡 60-79%</span> = Aging
                      <br />
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      Predicts when the battery will reach 70% SoH (typical EOL
                      threshold).
                      <br />
                      <br />
                      Based on your usage patterns and environmental conditions
                      (temperature, discharge rate). Use this to plan
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      <span className="font-bold">Physics Model:</span> Based on
                      degradation equations
                      <br />
                      <span className="font-bold">ML Correction:</span> Learned
                      from real-world data
                      <br />
                      <span className="font-bold">Hybrid:</span> Best of both
                      approaches for accuracy
                    </p>
                  </div>
                </div>
              </div>
            ...
            <>
              ...
              {(() => {
                // Calculate SoH and health status from results
                const soh = results.metrics?.remaining_capacity_percent || 0;
                const getHealthStatus = (soh: number) => {
                  if (soh >= 90) return "Healthy";
                  if (soh >= 80) return "Aging";
                  if (soh >= 70) return "Risk";
                  return "Critical";
                };
                const healthStatus = getHealthStatus(soh);
                const remainingCycles = results.eol_cycle
                  ? Math.max(
                      0,
                      results.eol_cycle -
                        results.cycles[results.cycles.length - 1]
                    )
                  : Math.max(0, (soh - 80) / 0.02);
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-gray-800/30 rounded-lg p-6 border border-gray-700">
                        ...
                        <ul className="space-y-2 text-gray-300 text-sm">
                          <li>
                            <span className="font-semibold">Current SoH:</span>{" "}
                            Your battery is at{" "}
                          ...
                          <li>
                            ...
                            Categorized as{" "}
                            <span className="text-white">{healthStatus}</span>
                          </li>
                          <li>
                            <span className="font-semibold">
                              Remaining Life:
                            ...
                            {results.eol_cycle ? (
                              <>
                                EOL predicted at{" "}
                                <span className="text-white">
                                  {results.eol_cycle} cycles
                                </span>{" "}
                                (~{remainingCycles} more cycles)
                              </>
                            ) : (
                              <>
                                Approximately{" "}
                                <span className="text-white">
                                  {Math.round(remainingCycles)}
                                </span>{" "}
                                more cycles
                              </>
                            )}
                      ...
                      <div className="bg-gray-800/30 rounded-lg p-6 border border-gray-700">
                        ...
                        <ul className="space-y-2 text-gray-300 text-sm">
                          ...
                          {healthStatus === "Aging" && (
                            <>
                              <li>
                                ⚠ Battery is aging, plan for replacement soon
                              </li>
                          ...
                          {healthStatus === "Risk" && (
                            <>
                              ...
                              <li>
                                🔴 Reduce discharge current to slow degradation
                              </li>
                            </>
                          )}
                      ...
                      <div className="bg-gray-800/30 rounded-lg p-6 border border-gray-700 md:col-span-2">
                        ...
                        <p className="text-gray-300 text-sm mb-3">
                          VoltTwin uses a{" "}
                          <span className="font-semibold">hybrid approach</span>
                          :
                        </p>
                        <ul className="space-y-2 text-gray-300 text-sm">
                          <li>
                            ...
                            Applies the Xu et al. degradation equation based on
                            temperature (
                            {results.metrics?.operating_temperature_c}°C) and
                            discharge current (
                            {results.metrics?.discharge_current_a}A)
                          </li>
                          <li>
                            <span className="font-semibold">
                              ML Correction:
                            </span>{" "}
                            Neural network trained on real battery data learns
                            non-linear effects and corrects physics model
                            predictions
                          </li>
                          <li>
                            <span className="font-semibold">
                            ...
                            Combines physics rigor with ML accuracy for
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 text-sm">
                  <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700">
                    ...
                    <p className="text-gray-400">
                      Warranty forecasting & fleet health
                    </p>
                  </div>
                  <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700">
                    ...
                    <p className="text-gray-400">
                      Energy trading & maintenance planning
                    </p>
                  </div>
                  <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700">
                    ...
                    <p className="text-gray-400">
                      Route assignment & replacement forecasting
                    </p>
                  </div>
                  <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700">
                    ...
                    <p className="text-gray-400">
                      Home energy systems & cost savings
                    </p>
                  </div>
                  <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700">
                    ...
                    <p className="text-gray-400">
                      QA defect detection & cost control
                    </p>
                  </div>
                </div>
              </div>
        ...
        {showEvaluation && (
          <ModelEvaluation onClose={() => setShowEvaluation(false)} />
        )}
